<%-- 
    Document   : login
    Created on : 28/01/2019, 15:05:27
    Author     : JhosBonilla
--%>
...
<!---728x90--->
    ...
    <div class="content">
		...
		<div class="main vlcone add">
			<div class="alert-close"> </div>
			<div class="hotel-left">
				<div class="pay_form">
					<h2>INGRESAR AQUI</h2>
					<form>
						<input class="logo" type="text" value="usuario" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" required="">
						<input class="key" type="password" value="contraseña" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
			...
			<div class="hotel-right">
				...
				<p>Un lugar perfecto para realizar sus compras.</p>
			</div>
			<div class="clear"></div>
		</div>
		<!---728x90--->

		<p class="footer">&copy; 2016 Digital Login Form Widget. All Rights Reserved | Design by <a href="http://w3layouts.com/"> W3layouts</a></p>
	</div>
</body>
</html>
